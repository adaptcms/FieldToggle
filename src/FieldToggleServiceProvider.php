...
class FieldToggleServiceProvider extends ServiceProvider
{
  /**
  ...
  {
    $this->mergeConfigFrom(__DIR__.'/../config/fieldtoggle.php', 'fieldtoggle');

    // Register the service the package provides.
    $this->app->singleton('FieldToggle', function ($app) {
      return new FieldToggle;
    });
  }
  ...
  protected function bootForConsole()
  {
    ...
    $this->publishes([
        __DIR__.'/../config/fieldtoggle.php' => config_path('fieldtoggle.php'),
    ], 'fieldtoggle.config');
